...
INSERT INTO `messages` VALUES (1,'Приветствие','Ну привет, дружище! Как у тебя дела?',2,1,1,''),(2,'Вопрос по делу № 134','Поступили новые указания, касательно работы в данном проекте. Как ты на них смотришь?',3,1,1,''),(3,'Задача на завтра','Привет! Как успехи с учёбой? Высылаю тебе задачу, которую хорошо бы сделать к завтрашнему дню',4,1,1,''),(4,'Приглашение в чат','Привет! Хочу пригласить тебя в чат наших супер крутых чуваков',2,1,1,'2024-01-22 13:03:12'),(5,'Эй, дружище на ID 2','Это я так, хочу глянуть придёт ли это письмо челу с id - 1',3,2,0,'2024-01-22 13:03:12'),(6,'Туц-туц','Да это я так, решил просто тебе написать, дружище',1,2,0,'2024-01-22 13:03:12'),(7,'Кац-кац','Хехеййййййй, давай дружить',4,2,0,'2024-01-22 13:03:12'),(8,'Дарова','Как твои дела? Давай знакомится и дружить?',1,3,0,'2024-01-22 13:03:12'),(9,'Hello','Дратути. Я бы хотел с тобой дружить',2,3,0,'2024-01-22 13:03:12'),(10,'Привет мучачос','Здаровосто, асталовисто беби',4,3,0,'2024-01-22 13:03:12'),(11,'Ну здраствуй амиго','Как твои дела, дружище, давно не виделись! Давай встретимся',1,4,0,'2024-01-22 13:03:12'),(12,'Делопроизводителю','Здравствуйте! Необходимо явится на работу завтра. Накопилось много документов',2,4,0,'2024-01-22 13:03:12'),(13,'Го бухать','Дарова, дружбанннннн!!! У меня завтра день рождения, пошли бухнем как следует',3,4,0,'2024-01-22 13:03:12'),(14,'Пробное письмо','Пробное письмо',1,4,0,'2024-01-22 13:03:12'),(15,'Пробное письмо самому себе','Пробное письмо самому себе',1,1,1,'2024-01-22 13:03:12'),(16,'Пробное письмо самому себе','Пробное письмо самому себе',1,1,1,'2024-01-22 13:03:12'),(17,'Повторное письмо самому себе','Пробное письмо самому себе',1,1,1,'2024-01-22 13:03:12'),(18,'Проверка на дату ','Проверяю будет ли введена дата и время отправки сообщения',1,1,1,'2024-01-22 13:03:12'),(19,'Проверка на дату ','Проверяю будет ли введена дата и время отправки сообщения',1,1,1,'2024-01-22 13:03:12'),(20,'Проверка на дату повторное','Повторно проверяю вывод даты и времени отправки письма',1,1,1,'2024-01-22 13:03:32'),(21,'Сами сусами','Сам сусам',1,1,1,'2024-01-22 14:01:30'),(22,'DDDDDDD','DDDDD',1,1,1,'2024-01-22 14:06:06'),(23,'qwerty','qwertt',1,1,0,'2024-01-22 14:20:01'),(24,'ДРАААААТУТИ','ДРАААААТУТИ',1,1,1,'2024-01-22 14:22:31'),(25,'FPFPFPFPFP','fpfpfpfpfpfpfpfp',1,1,1,'2024-01-22 14:23:19');
...
-- Dump completed on 2024-01-22 17:27:52
